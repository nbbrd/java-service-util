...
- Add ServiceId annotation [#244](https://github.com/nbbrd/java-service-util/issues/244)
...
[Unreleased]: https://github.com/nbbrd/java-service-util/compare/v1.6.1...HEAD
